...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String UPLOAD_URL = "http://192.168.100.42/uploadImage/upload.php";
    public static final String UPLOAD_KEY = "image";
    private static final String IMAGE_DIRECTORY = "/UploadImage";
    ...
    private String saveImageToLocal(Bitmap myBitmap)
    {
        ...
        try {
            File f = new File(walpaperDirectory, Calendar.getInstance()
                    .getTimeInMillis() + ".jpg");
            f.createNewFile();
